                ...
                <Card className="border-0 shadow-xl bg-white/95 backdrop-blur-sm overflow-hidden transform hover:scale-[1.01] transition-all duration-500 rounded-2xl">
                  ...
                  <CardHeader className="space-y-1 pb-6 pt-8 text-center">
                    ...
                    <CardDescription className="text-slate-600 text-base">
                      Masukkan kredensial Anda untuk mengakses dashboard dan mulai deteksi penyakit tanaman
                    </CardDescription>
                    ...
                    <Form {...form}>
                      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        >
                          ...
                          {isLoading ? "Sedang Login..." : "Masuk Akun"}
                        </Button>
                      </form>
                    </Form>
                  </CardContent>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/20 hover:shadow-2xl transition-all duration-500 group relative overflow-hidden">
                  ...
                  <div className="text-center relative">
                    ...
                    <h3 className="text-2xl font-bold text-slate-800 mb-3">Deteksi AI Cerdas</h3>
                    <p className="text-slate-600 leading-relaxed">
                      Teknologi machine learning terdepan untuk mengidentifikasi penyakit tanaman dengan akurasi tinggi dan analisis mendalam
                    </p>
                    
                    {/* Feature Tags */}
                    <div className="flex flex-wrap justify-center gap-2 mt-4">
                      {["Neural Network", "Computer Vision", "Deep Learning"].map((feature, idx) => (
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { icon: TrendingUp, value: "98.7%", label: "Akurasi", color: "from-blue-400 to-blue-500", detail: "Neural Network" },
                    { icon: Shield, value: "25+", label: "Penyakit", color: "from-emerald-400 to-green-500", detail: "Database Lengkap" },
                    { icon: Users, value: "15K+", label: "Petani", color: "from-teal-400 to-emerald-500", detail: "User Verified" },
                    { icon: Zap, value: "2.3s", label: "Response", color: "from-purple-400 to-purple-500", detail: "Ultra Fast" }
                  ].map((stat, index) => (
                    <div 
                      key={index} 
                ...
                <Link 
                  href="/register"
                  className="block w-full bg-gradient-to-r from-emerald-50 to-teal-50 hover:from-emerald-100 hover:to-teal-100 text-emerald-700 font-bold py-4 rounded-xl transition-all duration-300 border border-emerald-200 text-center group relative overflow-hidden shadow-md hover:shadow-lg"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-100/0 via-emerald-100/50 to-emerald-100/0 -skew-x-12 transform -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                  <div className="flex items-center justify-center">
                ...
                <div className="flex justify-center items-center space-x-6 mt-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-xs font-medium text-slate-600">Secure Login</span>
                  </div>
                </div>
              </div>
            </div>
